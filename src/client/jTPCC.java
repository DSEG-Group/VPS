...
public class jTPCC implements jTPCCConfig
{
	...
	if (databaseDriverLoaded && resultDirectory != null)
	{
		...
		resultCSV.write("run,transGenerateTime,transStart,elapsed,latency,dblatency," +
				"ttype,rbk,dskipped,Value_pre,Value_real,Prioity,error\n");
	    }
	    catch (IOException e)
	    {
		log.error(e.getMessage());
    ...
    public void signalTerminalEndedTransaction(String terminalName, String transactionType, long executionTime, String comment, int newOrder,double transVal)
    {
